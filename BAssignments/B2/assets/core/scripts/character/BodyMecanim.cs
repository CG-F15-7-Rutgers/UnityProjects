...
*/
	...
	{
		//this.animator.SetBool ("B_Breakdance", true);
		this.animator.SetBool ("B_Duck", true);
	}
	...
	{
		//this.animator.SetBool ("B_Breakdance", false);
		this.animator.SetBool ("B_Duck", false);
	...
	public bool IsDancing()
	{
		...
		return this.animator.GetBool ("B_Duck");
	}
	...
	public bool DanceHasFinished() {
		return this.animator.GetCurrentAnimatorStateInfo(0).IsName ("B_Duck");
	}
