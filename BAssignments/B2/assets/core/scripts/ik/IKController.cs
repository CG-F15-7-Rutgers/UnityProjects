...
public class IKController : MonoBehaviour 
{
    ...
    void Update()
    {
		...
		if (isCreepy) {
			...
			ik.solver.bodyEffector.position = transform.position + new Vector3 (2, 1, -1);
			ik.solver.bodyEffector.positionWeight = .7f;
			ik.solver.bodyEffector.maintainRelativePositionWeight = .5f;
		}
