...
public class CharacterMecanim : MonoBehaviour
{
	...
	public virtual RunStatus NavDance() {
		this.Body.BreakDance ();
		if (!this.Body.DanceHasFinished ()) {
			return RunStatus.Running;
		}
		return RunStatus.Success;
	}
	...
	public virtual RunStatus NavStopDance() {
		this.Body.stopDance ();
		if (!this.Body.DanceHasFinished ()) {
			return RunStatus.Running;
		}
...
/*
	public virtual RunStatus ScaryCreepy() {
		this.Body.ScaryCreepy ();
		return RunStatus.Success;
	}  */
