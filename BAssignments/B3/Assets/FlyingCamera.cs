...
public class FlyingCamera : MonoBehaviour
{
	...
	void Update()
	{
		...
		transform.position += transform.forward * Input.GetAxis("Vertical1") * deltaMove;
		//transform.position += transform.forward * Input.GetKey(KeyCode.N) * deltaMove;
		transform.position += transform.right * Input.GetAxis("Horizontal1") * deltaMove;
		//transform.position += transform.right * Input.GetKey(KeyCode.M) * deltaMove;
